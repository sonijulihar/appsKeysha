...
class M_penjualan extends CI_Model{
	...
	function simpan_penjualan($nofak,$total,$jml_uang,$kembalian,$pembeli,$alamat){
		$idadmin=$this->session->userdata('idadmin');
		$this->db->query("INSERT INTO tbl_jual (jual_nofak,jual_total,jual_jml_uang,jual_kembalian,jual_user_id,jual_keterangan,pembeli,alamat) VALUES ('$nofak','$total','$jml_uang','$kembalian','$idadmin','eceran','$pembeli','$alamat')");
		foreach ($this->cart->contents() as $item) {
			...
			$this->db->query("update mst_memo set memo=memo+1");
		}
		return true;
	}
	function get_nofak(){
