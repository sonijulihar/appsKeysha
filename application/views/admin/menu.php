 <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url().'welcome'?>">Keisha Jaya</a>
            </div>
                   ...
                   <?php $h=$this->session->userdata('akses'); ?>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo base_url().'admin/penjualan'?>"><span class="fa fa-shopping-bag" aria-hidden="true"></span> Penjualan (Agen)</a></li> 
                            <li><a href="<?php echo base_url().'admin/penjualan_grosir'?>"><span class="fa fa-cubes" aria-hidden="true"></span> Penjualan (Kasir)</a></li> 
                        </ul>
                    </li>
                    <!--ending dropdown-->
                    <li>
                    ...
                    <?php }?>
                     <li>
                        <a href="<?php echo base_url().'admin/pelanggan'?>"><span class="fa fa-user"></span> Pelanggan</a>
                    </li>
                     <li>
