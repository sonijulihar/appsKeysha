...
<head>
    ...
    <meta name="author" content="Keisha Jaya">
   ...
   ?>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <!--    <tr>
                    <th>Bayar(Rp)</th>
                    <th style="text-align:right;"><input type="text" id="jml_uang" name="jml_uang" class="jml_uang form-control input-sm" style="text-align:right;margin-bottom:5px;" value="0" required></th>
                    <input type="hidden" id="jml_uang2" name="jml_uang2" class="form-control input-sm" style="text-align:right;margin-bottom:5px;" disabled>
                </tr>
                <tr>
                    <td></td>
                    <th>Tambahan</th>
                    <th style="text-align:right;"><input type="text" id="kembalian" name="kembalian" class="form-control input-sm" style="text-align:right;margin-bottom:5px;" value="0" disabled=""></th>
                </tr>-->
             <!--<tr>
                    <td></td>
                    <th>PEMBELI</th>
                    <th style="text-align:right;"><input type="text" id="vendor" name="vendor" class="form-control input-sm" style="text-align:right;margin-bottom:5px;" required></th>
                </tr>-->
        ...
        <!-- /.row -->
           ...
           <div class="form-group">
                    <label class="col-sm-1 control-label">Pelanggan</label>
                <div class="col-sm-3">
                    <select class="form-control input-sm" id="vendor" name="vendor">
                    <option value=""></option>
                    <?php
                     foreach ($datavendor->result() as $row) {
                          echo "<option value='".$row->pelanggan_nama."'>".$row->pelanggan_nama."</option>";
                        }
                          ?>
                            </select>
             ...
             <div class="form-group">
               <label class="col-sm-1 control-label"> Alamat</label>
                <div class="col-sm-3">
                <input type="text" name="alamat" id="alamat" class="form-control input-sm"></div>
            </div>
                  ...
                  <table class="table table-bordered table-condensed" style="font-size:11px;" id="mydata">
                    <thead>
                        <tr>
                            ...
                            <th>Satuan</th>
                            <th style="width:100px;">Harga (Agen)</th>
                            <th>Stok</th>
                            <th style="width:100px;text-align:center;">Aksi</th>
                        </tr>
                    </thead>
        ...
        <footer>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <br><br>
                    <p style="text-align:center;">Copyright &copy; <?php echo '2020';?> by Keisha Jaya</p>
                </div>
            </div>
            <!-- /.row -->
        </footer>
...
<!--    <script type="text/javascript">
    ...
    <script type="text/javascript">
        ...
        //if ($(this).val() !== ''){ 
               var data={field1: $("#vendor").val()};
                $.ajax({ 
                    url : "<?php echo base_url('admin/penjualan/ajax_pelanggan'); ?>",
                    type : "POST",
                    data : data,
                    dataType : 'json',
